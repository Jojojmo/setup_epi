...
if __name__ == '__main__':
  ...
  #python get_data.py "C:\Users\jmoni\OneDrive\Área de Trabalho\Fatec\5° Sem\TCC\testes\image_list.txt" --num_processes 10 --download_folder "C:\Users\jmoni\OneDrive\Área de Trabalho\Fatec\5° Sem\TCC\testes\data"


 #$backfolder= Split-Path -Parent (Get-Location); python dowload_images.py "$pwd\image_list.txt" --num_processes 10 --download_folder "$backfolder\data\temp"

 # cd setup
 # python make_labels.py
 # $backfolder= Split-Path -Parent (Get-Location);
 # python dowload_images.py "$pwd\list_images\validation_images_list.txt" --num_processes 10 --download_folder "$backfolder\data\helmets\valid\images"
 # python dowload_images.py "$pwd\list_images\train_images_list.txt" --num_processes 10 --download_folder "$backfolder\data\helmets\train\images"
 # python dowload_images.py "$pwd\list_images\test_images_list.txt" --num_processes 10 --download_folder "$backfolder\data\helmets\test\images"